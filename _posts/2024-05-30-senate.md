...
<div class="heatmap-dashboard">
    ...
    <script>
        function updateHeatmap() {
            ...
            var mapImage = `https://raw.githubusercontent.com/naponjatusripitak/naponjatusripitak.github.io/master/assets/img/heatmaps/heatmap_${province}.jpg`;
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            elem.addEventListener('click', function() {
                ...
                }, 1000); // Slight delay to ensure mediumZoom modal is fully opened
            });
