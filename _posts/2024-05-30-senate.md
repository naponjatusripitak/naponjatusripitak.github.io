...
<div class="heatmap-dashboard">
    ...
    <script>
      ...
      heatmap.addEventListener('mousedown', (e) => {
          ...
          startX = e.pageX - heatmap.offsetLeft;
          startY = e.pageY - heatmap.offsetTop;
          scrollLeft = heatmap.parentElement.scrollLeft;
          scrollTop = heatmap.parentElement.scrollTop;
      });
      ...
      heatmap.addEventListener('mouseup', () => {
          isDragging = false;
          heatmap.style.cursor = 'grab';
      });
      ...
      heatmap.addEventListener('mousemove', (e) => {
          ...
          e.preventDefault();
          const x = e.pageX - heatmap.offsetLeft;
          const y = e.pageY - heatmap.offsetTop;
          const walkX = (x - startX) * 2; // Adjust the scroll speed
          const walkY = (y - startY) * 2; // Adjust the scroll speed
          heatmap.parentElement.scrollLeft = scrollLeft - walkX;
          heatmap.parentElement.scrollTop = scrollTop - walkY;
      });
    </script>
</div>
