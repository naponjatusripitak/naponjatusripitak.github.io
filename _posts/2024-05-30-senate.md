...
<div class="heatmap-dashboard">
    ...
    <div class="heatmap-container">
        <img src="https://github.com/naponjatusripitak/naponjatusripitak.github.io/blob/master/assets/img/heatmaps/heatmap_กรุงเทพมหานคร.jpg" id="heatmap" class="img-fluid rounded z-depth-1" zoomable="true" />
    </div>
    <script>
        function updateHeatmap() {
            var province = document.getElementById('province').value;
            var heatmapImage = document.getElementById('heatmap');
            heatmapImage.src = `https://github.com/naponjatusripitak/naponjatusripitak.github.io/blob/master/assets/img/heatmaps/heatmap_${province}.jpg`;
        }
    </script>
    <script>
