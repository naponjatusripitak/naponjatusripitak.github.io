...
<div class="heatmap-dashboard">
    ...
    <script>
        ...
        // Event listener to handle zoom end and enable dragging
        zoom.on('closed', () => {
            ...
            if (zoomedImage) {
                ...
                zoomedImage.style.maxWidth = 'none'; // Prevent image from resizing
                zoomedImage.style.maxHeight = 'none'; // Prevent image from resizing
            }
        });
        ...
        document.addEventListener('mousedown', (e) => {
            ...
            if (zoomedImage) {
                ...
                scrollLeft = zoomedImage.parentElement.scrollLeft;
                scrollTop = zoomedImage.parentElement.scrollTop;
            }
        });
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            if (zoomedImage) {
                ...
                zoomedImage.parentElement.scrollLeft = scrollLeft - walkX;
                zoomedImage.parentElement.scrollTop = scrollTop - walkY;
            }
        });
    </script>
</div>
