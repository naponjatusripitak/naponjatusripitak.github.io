...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        container.addEventListener('mousemove', (e) => {
            ...
            const walkX = (x - startX) * 1; // Adjust scroll speed
            const walkY = (y - startY) * 1; // Adjust scroll speed
            container.scrollLeft = scrollLeft - walkX;
            container.scrollTop = scrollTop - walkY;
        });

        heatmap.addEventListener('load', () => {
            const naturalWidth = heatmap.naturalWidth;
            const naturalHeight = heatmap.naturalHeight;
            heatmap.style.width = `${naturalWidth}px`;
            heatmap.style.height = `${naturalHeight}px`;
        });
